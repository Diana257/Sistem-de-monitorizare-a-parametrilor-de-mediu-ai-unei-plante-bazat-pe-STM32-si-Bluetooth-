...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	    // Porneste pompa
	    HAL_GPIO_WritePin(MOTOR_BI_GPIO_Port, MOTOR_BI_Pin, GPIO_PIN_SET);
	    HAL_GPIO_WritePin(MOTOR_FI_GPIO_Port, MOTOR_FI_Pin, GPIO_PIN_RESET);
	    HAL_Delay(5000);

	    // Opreste pompa
	    HAL_GPIO_WritePin(MOTOR_BI_GPIO_Port, MOTOR_BI_Pin, GPIO_PIN_RESET);
	    HAL_GPIO_WritePin(MOTOR_FI_GPIO_Port, MOTOR_FI_Pin, GPIO_PIN_RESET);
	    HAL_Delay(5000);
    /* USER CODE BEGIN 3 */
  }
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : DHT11_Pin_Pin MOTOR_BI_Pin */
  GPIO_InitStruct.Pin = DHT11_Pin_Pin|MOTOR_BI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : WATER_SENSOR_Pin */
